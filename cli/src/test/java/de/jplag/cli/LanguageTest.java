...
//        assertEquals(CliOptions.defaultLanguage.getIdentifier(), options.languages().getFirst().getIdentifier());
//    }
//
//    @Test
...
//
//            assertEquals(language.getIdentifier(), options.languages().getFirst().getIdentifier());
